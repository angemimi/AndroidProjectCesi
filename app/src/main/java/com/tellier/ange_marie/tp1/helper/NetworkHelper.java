package com.tellier.ange_marie.tp1.helper;
...
public class NetworkHelper {
     ...
     * @return
     */
    public static Http_result doGet(String purl, Map<String, String> params, String token)  {
        ...
        try {
            ...
            if(response != 200){
                return new Http_result(response, null);
            } else {
                inputStream = conn.getInputStream();

                // Convert the InputStream into a string
                String contentAsString = NetworkHelper.readIt(inputStream);
                return new Http_result(response, contentAsString);
    ...
    public static Http_result doPost(String purl, Map<String, String> params, String token)  {
